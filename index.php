    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                ...
                <h3 class="section-subheading text-muted">What we have done so far.</h3>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4 col-sm-6 portfolio-item">
                <a href="photography.php" class="portfolio-link" data-toggle="modal">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                ...
                <h3 class="section-subheading text-muted">We are team of two.</h3>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-4">
...
<section id="contact">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <form name="sentMessage" id="sendForm" novalidate>
                    <div class="row">
                        <div class="col-md-6">
                ...
                <div class="space"></div>
                <div class="alert alert-success" id="feedback">
